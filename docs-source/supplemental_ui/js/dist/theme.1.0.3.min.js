...
*/
var ytID;function OptanonWrapper(){$("a.yt-widget").each((function(e){var t=$(this),a=$(this).attr("href"),n=t[0].search;let r=new URLSearchParams(n);ytID=r.get("v"),$(this).before('<div class="flex-video-wrapper"><div class="flex-video"><div id="yt-'+ytID+'" class="cookie-warning youtube-warning"><a class="optanon-allow-all" onclick="OneTrust.AllowAll();">Accept cookies to view video</a><span>Alternatively you can watch the video <a href="'+a+'" target="_blank">here on YouTube</a></span></div></div></div>'),$(this).removeAttr("href").removeClass("yt-widget").addClass("yt-widget-hide")})),$(".youtube-warning").each((function(e){var t=$(this).attr("id").slice(3);OneTrust.InsertHtml('<iframe id="player" class="youtube-embed-player" src="//www.youtube.com/embed/'+t+'?rel=0&modestbranding=0" frameborder="0" webkitAllowFullScreen mozallowfullscreen allowFullScreen></iframe>',"yt-"+t,null,{deleteSelectorContent:!0},"4")}))}!function(e){e((function(){var t="#page-content";e("#page-viewed-trigger").length&&(t="#page-viewed-trigger");new Waypoint.Inview({element:e(t)[0],entered:function(e){dataLayer.push({event:"pageContentViewed"})}})}))}(jQuery);