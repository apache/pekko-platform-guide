...
* The {akka-blog}/news/2019/12/03/akka-typed-actor-intro-video[Akka Actor introduction video {tab-icon}, window="tab"] is a good starting point for learning Pekko Actors.
