...
{akka-grpc}/server/walkthrough.html[Akka gRPC walk-through {tab-icon}, window="tab"]

{akka-grpc}/client/configuration.html#using-akka-discovery-for-endpoint-discovery[Service Discovery {tab-icon}, window="tab"]
...
{akka-grpc}/client/walkthrough.html[Client walk-through {tab-icon}, window="tab"]
