...
{reactive-principles}/principles/stay-responsive.html[fail-fast] {reactive-principles}/principles/stay-responsive.html[{tab-icon}, window="tab"], letting the user know that something is wrong and that they need not refresh
...
For more information, including code examples in Akka, see {akka}/common/circuitbreaker.html[Akka CircuitBreaker reference documentation].
