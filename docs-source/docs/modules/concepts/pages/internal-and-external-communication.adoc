...
* {akka}/typed/index-cluster.html[Akka Cluster] provides multiple features (pub-sub, distributed data, sharding, reliable delivery,...) for intra-service communication.
