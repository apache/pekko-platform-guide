...
[NOTE]
====
* The xref:microservices-tutorial:projection-kafka.adoc[] in the tutorial illustrates how to use Kafka for asynchronous communication between Microservices.
* The xref:microservices-tutorial:projection-grpc-client.adoc[] uses Akka gRPC for synchronous communication between two Microservices.
* The xref:microservices-tutorial:entity.adoc[] uses Akka Cluster Sharding for communication within a Microservice.
* The xref:microservices-tutorial:projection-query.adoc[] uses the event journal (database) for communication within a Microservice.
====
