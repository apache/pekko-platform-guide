...
CQRS documentation in the link:{akka-projection}/use-cases.html[Akka Projections documentation].
...
link:{akka-projection}/[Akka Projections] is designed to listen to a stream of events and build up data in a different representation, a projection.
