...
* The {akka-blog}/news/2019/12/16/akka-cluster-sharding-intro-video[Introduction to Pekko Cluster Sharding video {tab-icon}, window="tab"] is a good starting point for learning Akka Cluster Sharding.
