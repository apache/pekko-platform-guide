...
To learn more about migrating from CRUD modelling to Event Sourcing, read the xref:how-to:from-crud-to-eventsourcing.adoc[] page and follow the xref:shopping-microservices:entity.adoc[] and the xref:shopping-microservices:complete-entity.adoc[] sections of the xref:shopping-microservices:index.adoc[tutorial].
