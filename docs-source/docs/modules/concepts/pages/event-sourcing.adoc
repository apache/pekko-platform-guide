...
See an https://docs.microsoft.com/en-us/previous-versions/msp-n-p/jj591559(v=pandp.10)?redirectedfrom=MSDN[introduction to EventSourcing] at MSDN.
...
{lagom}/scala/ESAdvantage.html[Advantages of Event Sourcing] {lagom}/scala/ESAdvantage.html[{tab-icon}, window="tab"]