= Akka Platform Operator reference
:page-toclevels: 3
...
The deployment descriptor of an Akka Microservice that is managed by the Akka Platform Operator is defined in a https://kubernetes.io/docs/tasks/extend-kubernetes/custom-resources/custom-resource-definitions/[Kubernetes Custom Resource {tab-icon}, window="tab"].
