...
Create a new database from https://console.aws.amazon.com/rds/home:[Amazon Container Services console]. Select the region you are working in.
...
FIXME the details of main.conf should probably be described in a separate (general) page.
