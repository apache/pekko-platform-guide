...
Follow the instructions in the https://github.com/aws/eks-charts/tree/master/stable/aws-load-balancer-controller[AWS Load Balancer Controller Helm chart for Kubernetes {tab-icon}, window="tab"]
