...
6. Setup an Amazon Managed Streaming for Apache Kafka (MSK) cluster
7. Setup an Amazon Aurora Relational Database Service (RDS) cluster
...
| Whether to install the Kubernetes metrics server.
| No
| `true`
