...
6. Install AWS OTel Collector to see application traces in X-Ray Console
...
AWS OTel Collector collects traces from applications instrumented with Lightbend Telemetry 2.16.1+ and sends them to X-Ray.
