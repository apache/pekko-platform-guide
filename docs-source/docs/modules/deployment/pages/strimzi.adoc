...
[source,shell script]
----
kubectl create namespace pekko-demo
----
...
[source,shell script]
----
helm install strimzi strimzi/strimzi-kafka-operator --namespace pekko-demo
----
...
[source,shell script]
----
kubectl config set-context --current --namespace=pekko-demo
----
...
[source,shell script]
----
helm delete strimzi -n pekko-demo
----
