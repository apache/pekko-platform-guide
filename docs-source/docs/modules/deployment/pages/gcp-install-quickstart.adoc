...
A new installation will take approximately  _20 minutes_, and by default, the following components will be provisioned:
...
5. Setup a PostgreSQL Database Instance
