...
|----------------------------|----------|------------------------------------------------------------------|
| `ReconciliationSuccessful` | `Normal` | The reconciliation of a Microservice has completed successfully. |
| `ReconciliationFailure`    | `Error`  | The reconciliation of a Microservice has failed.                 |
----
