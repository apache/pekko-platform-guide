...
This describes how to use PostgreSQL because that is what is used in the xref:microservices-tutorial:index.adoc[Implementing Microservices with Pekko tutorial], but it would be similar for the other database engines.
...
The example in the xref:microservices-tutorial:index.adoc[Implementing Microservices with Pekko tutorial] is using PostgreSQL.
