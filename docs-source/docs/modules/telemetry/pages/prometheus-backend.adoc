...
Here is the core Cinnamon Prometheus dependency you need to add to your `pom.xml` together with the {telemetry}/plugins/prometheus/prometheus.html#http-server[HTTP server exporter]:
...
See {telemetry}/plugins/prometheus/prometheus.html[our docs for more details and reference configuration].
