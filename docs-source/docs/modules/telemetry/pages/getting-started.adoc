...
After adding the Cinnamon Agent as described above, make sure that you add the {cinnamon-docs}/instrumentations/instrumentations.html[Cinnamon instrumentations {tab-icon}, window="tab"] that are necessary for your application. In this example, we add instrumentations for {cinnamon-docs}/instrumentations/akka/akka.html[Akka {tab-icon}, window="tab"], {cinnamon-docs}/instrumentations/akka-persistence/akka-persistence.html[Akka Persistence {tab-icon}, window="tab"], {cinnamon-docs}/instrumentations/akka-projection/akka-projection.html[Akka Projection {tab-icon}, window="tab"], {cinnamon-docs}/instrumentations/akka-http/akka-http.html[Akka HTTP, and Akka gRPC {tab-icon}, window="tab"]:
