...
****
* link:_attachments/0-shopping-cart-start-scala.zip[Source] with initial project template. Alternatively, use `sbt` to start a new project as explained in xref:template.adoc[Run the template].
