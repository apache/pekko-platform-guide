...
* call another service with xref:concepts:pekko-grpc.adoc[Pekko gRPC]
...
* {pekko-grpc}/client/index.html[Pekko gRPC client reference documentation {tab-icon}, window="tab"].
