...
* call another service with xref:concepts:pekko-grpc.adoc[Akka gRPC]
...
* {pekko-grpc}/client/index.html[Akka gRPC client reference documentation {tab-icon}, window="tab"].
