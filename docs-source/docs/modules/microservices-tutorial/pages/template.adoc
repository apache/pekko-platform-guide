...
For example, once a piece of functionality is complete, you can run one Pekko Cluster node with `local1.conf` as follows:
...
|===
|Node |Pekko Cluster |Pekko Management HTTP |Pekko gRPC
