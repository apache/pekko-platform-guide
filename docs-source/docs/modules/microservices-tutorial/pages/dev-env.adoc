...
== Akka Workshop
The video based https://info.lightbend.com/pekko-platform-workshop-part-1-on-demand-recording.html[Akka Workshop Series {tab-icon}, window="tab"] series covers the details of setting up your development environment.
