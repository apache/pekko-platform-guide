...
public class SendOrderProjection {
    ...
    private static AtLeastOnceProjection<Offset, EventEnvelope<ShoppingCart.Event>> createProjectionsFor(ActorSystem<?> system, ShoppingOrderService orderService, int index) {
