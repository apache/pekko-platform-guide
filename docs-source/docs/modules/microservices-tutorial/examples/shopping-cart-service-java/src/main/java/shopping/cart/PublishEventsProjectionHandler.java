...
public final class PublishEventsProjectionHandler extends Handler<EventEnvelope<ShoppingCart.Event>> {
    ...
    @Override
    public CompletionStage<Done> process(EventEnvelope<ShoppingCart.Event> envelope) throws Exception, Exception {
    ...
    private static byte[] serialize(ShoppingCart.Event event) {
        ...
        if (event instanceof ShoppingCart.ItemAdded) {
            ...
            protoMessage = shopping.cart.proto.ItemAdded.newBuilder()
            ...
            ShoppingCart.ItemQuantityAdjusted itemQuantityAdjusted = (ShoppingCart.ItemQuantityAdjusted) event;
            protoMessage = shopping.cart.proto.ItemQuantityAdjusted.newBuilder()
            ...
            protoMessage = shopping.cart.proto.ItemRemoved.newBuilder()
            ...
            protoMessage = shopping.cart.proto.CheckedOut.newBuilder()
