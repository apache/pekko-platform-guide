...
Here we use five different tags. The tagging is not easy to change later without system downtime. Before going live in production you should consider how many tags to use, see link:{akka-projection}/running.html[Akka Projection reference documentation] for more information.
