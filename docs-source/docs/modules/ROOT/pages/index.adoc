...
The xref:shopping-microservices:index.adoc[Implementing Microservices with Akka] illustrates how to implement Event Sourcing with Akka Persistence and CQRS using Akka Projections.
