...
The easiest way to deploy and manage Akka Microservices in Kubernetes is to use the Akka Cloud Platform. The xref:deployment:index.adoc[Cloud deployment] section gives an overview of how the Kubernetes deployment with the Akka Cloud Platform works.
